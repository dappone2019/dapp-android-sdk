package com.blockchain.dappbirds.opensdk.db.cache;
...
import com.blockchain.dappbirds.opensdk.utils.Codec;
import com.blockchain.dappbirds.opensdk.utils.PhoneInfo;
...
public class DiskCache implements ICache {
    ...
    private DiskCache(Context context) {
        ...
        try {
            ...
            cache = DiskLruCache.open(cacheDir, PhoneInfo.getVersionCode(context), 1, 10 * 1024 * 1024);        //10M
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
